/* This script is intended to be run in the Google Earth Engine code editor.
This script uses analysis ready imagery from the USGS's Landsat 8 Collection 2 image collection.
Imagery for a given timeframe and location is loaded and mosaiced for further anlaysis.
The uses TIRS band 10 to derrive land surface temperature (LST). LST is then converted from 
kelvin to fahrenheit. The processed LST layer is added to the map and exported as a geoTiff
to the designated Google Drive location. */
var geoid = "DFW";
var year = '2023';
...
//Provide bounding box coordinates for your area of interest
